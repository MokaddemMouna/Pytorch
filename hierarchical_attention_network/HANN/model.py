...
class HierarchialAttentionNetwork(nn.Module):
    ...
    def forward(self, documents, sentences_per_document, words_per_sentence):
        ...
        # Classify
        # softmax layer will be applied by the loss function in the main method
...
class SentenceAttention(nn.Module):
    ...
    def __init__(self, vocab_size, emb_size, word_rnn_size, sentence_rnn_size, word_rnn_layers, sentence_rnn_layers,
        ...
        # input is the sentence vector which is the weighted sum of h_it of dim 2 * word_rnn_size
    ...
    def forward(self, documents, sentences_per_document, words_per_sentence):
        ...
        # all s_i, the vector representations of all sentences and the word weights alphas
        ...
        # u_i * u_s, u_s sentence context vector
...
class WordAttention(nn.Module):
    ...
    def __init__(self, vocab_size, emb_size, word_rnn_size, word_rnn_layers, word_att_size, dropout):
        ...
        # 2 * word_rnn_size because the rnn is bidirectional and the result vector is the concatenation of the forward
    ...
    def forward(self, sentences, words_per_sentence):
        ...
        # h_it with t in [1,T] number of words per sentence i
        ...
        # Take the dot-product of the attention vectors with the context vector (i.e. parameter of linear layer)
        # u_it * u_w ; u_w is the context vector
        ...
        # alpha_it, of words t in [1,T] of s_i
        ...
        # sum_t(alpha_it * h_it), vectors representation of all sentences
